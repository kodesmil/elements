                ...
                components={{
                  ...
                  DropZone({ children, displayText, inDropZone, ...rest }) {
                    return (
                      <div
                        className={clsx(
                          'flex flex-col items-center gap-4 rounded border-0 bg-background p-8 align-middle',
                        ...
                        {files.map((file) => {
                          return (
                            <div
                              key={file.key}
                              className={
                                'flex flex-row items-center justify-between rounded border-0 bg-background p-3 align-middle'
                              }
                            >
                              <div
                                className={
